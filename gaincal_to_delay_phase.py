...
def main(args):
    ...
    freqs_hz = []
    phases_pol0 = [[] for ant in range(NANTS)]
    phases_pol1 = [[] for ant in range(NANTS)]
    ...
    for ant in range(NANTS):
        phases_pol0[ant] += indat['phases_pol0'][ant]
        phases_pol1[ant] += indat['phases_pol1'][ant]
    # 
    ...
    for ant in range(NANTS):
        print('Antenna %d' % ant)
        #unwrap_phases
        phases0 = np.unwrap(phases_pol0[ant])
        phases1 = np.unwrap(phases_pol1[ant])
        # Fit delay
        ...
        print('Pol 0 delay:')
        print(pol0_phase_slope)
        print('Pol 0 phase:')
        print(residual0)
        print('Pol 1 delay:')
        print(pol1_phase_slope)
        print('Pol 1 phase:')
        print(residual1)
