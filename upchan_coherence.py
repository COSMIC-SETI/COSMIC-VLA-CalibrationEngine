...
if __name__ == '__main__':
    ...
    parser.add_argument('-bc','--band-center', type = float, required = False, default = 0.5,  help = 'Bandwidth center to plot specified as a decimal percentage [0.0, 1.0]-`band`, default:0.5')
